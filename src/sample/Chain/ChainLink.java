...
public abstract class ChainLink {
    ...
    public ChainLink(InetSocketAddress address, InetSocketAddress[] nextLinks, InetSocketAddress[] previousLinks) {
        ...
        Logger logger = Logger.getLogger(ChainLink.class.getName());
    ...
    protected void send(Product product) throws IOException {
    ...
    private InetSocketAddress chooseRandomNextLink(InetSocketAddress[] links) {
